// server.js — API global con CORS y persistencia en JSON
const fs = require('fs');
...
const app = express();
app.use(cors());          // <— habilita CORS para llamadas desde GitHub Pages
app.use(express.json());

// (opcional) servir frontend si más adelante subís /public al mismo repo
